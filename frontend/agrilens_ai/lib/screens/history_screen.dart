...
//           ? const Center(child: Text("No scans yet. Analyze a leaf to see it here."))
//           : ListView.builder(
//         padding: const EdgeInsets.all(12),
//         itemCount: entries.length,
//         itemBuilder: (context, index) {
//           final entry = entries[index];
//           final bool isValid = entry.result.isValid;
//
//           Uint8List? thumbBytes;
//           if (isValid && entry.result.gradcamBase64.isNotEmpty) {
//             try {
...
//                   color: (isValid ? Colors.green : Colors.orange).withValues(alpha: 0.1),
...
//                 child: Text(
//                   "${entry.result.confidence.toStringAsFixed(1)}% • ${_formatTimestamp(entry.timestamp)}",
...
/// Lightweight color/icon lookup per diagnosis, mirroring the severity
/// treatment used on the result screen (Healthy / single deficiency /
/// multiple deficiencies / inconclusive).
class _EntryStyle {
  final Color color;
  final IconData icon;
